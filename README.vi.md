...
```
Cài Agent Reach cho tôi: https://raw.githubusercontent.com/louisdevzz/agent-reach/main/docs/install.md
```
...
```
Cập nhật Agent Reach cho tôi: https://raw.githubusercontent.com/louisdevzz/agent-reach/main/docs/update.md
```
...
> ```
> Cài Agent Reach cho tôi (chế độ an toàn): https://raw.githubusercontent.com/louisdevzz/agent-reach/main/docs/install.md
...
Dự án này hoàn toàn được vibe coding 🎸 có thể có một số chỗ chưa hoàn hảo, nếu gặp vấn đề mong bạn thông cảm. Có bug cứ mở [Issue](https://github.com/louisdevzz/agent-reach/issues), tôi sẽ sửa nhanh nhất có thể.
...
[PR](https://github.com/louisdevzz/agent-reach/pulls) luôn được chào đón!
...
> Báo bug và đề xuất tính năng vui lòng dùng [GitHub Issues](https://github.com/louisdevzz/agent-reach/issues), dễ theo dõi hơn.
